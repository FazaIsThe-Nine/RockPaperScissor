...
public class Player : MonoBehaviour
{
    ...
    public void Attack()
    {
        selectedCharacter.transform.DOMove(atkRef.position, 0.5f).SetEase(Ease.Linear);
    }
    ...
    public void Return()
    {
        selectedCharacter.transform.DOMove(selectedCharacter.InitialPosition, 0.5f).SetEase(Ease.Linear);  
    }
